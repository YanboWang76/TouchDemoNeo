...
{
    /// <summary>
    /// This script gives linear slider behaviour with force feedback.
    /// </summary>
    public class LinearSliderControllerForceFeedback : LinearSliderController,
        IPickableForceFeedback
    {
