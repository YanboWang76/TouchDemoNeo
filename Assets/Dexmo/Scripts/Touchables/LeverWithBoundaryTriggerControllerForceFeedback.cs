...
{
    /// <summary>
    /// This script gives lever behaviour with event trigger and force feedback.
    /// </summary>
    public class LeverWithBoundaryTriggerControllerForceFeedback: 
        LeverWithBoundaryTriggerController, IPickableForceFeedback
    {
