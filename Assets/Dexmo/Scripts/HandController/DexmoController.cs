    ...
    public class DexmoController : MonoBehaviour, IDexmoController
    {
        ...
        private void KeyboardControl(out Hand fakeHand)
        {
            ...
            Libdexmo.Model.Joint[] fakeJointsThumb =
                new Libdexmo.Model.Joint[3] { fakeJointMCPThumb, fakeJointPIPThumb, fakeJointDIPThumb };
        ...
        /// <summary>
        /// Debug function to modify max bound of rotation mapping
        /// </summary>
        /// <param name="bounds"></param>
        /// <param name="change"></param>
        private void ModifyHandRotationBoundsMax(BoundaryValue bounds, float change)
        {
            if (bounds != null)
            {
                bounds.ModifyMax(change);
            }
        }
